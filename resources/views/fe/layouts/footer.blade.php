...
<footer class="bg-primary-50 mt-auto w-full">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:pb-8 lg:pt-16">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0 md:w-1/2 w-full">
                {{-- <a href="https://flowbite.com/" class="flex items-center">
                    <img src="{{ storage_url('static/logo.png') }}" class="h-8 me-3" alt="FlowBite Logo" />
        ...
        <div class="flex flex-col md:flex-row items-center justify-between">
            <span class="text-sm text-gray-500 text-center">© {{ date('Y') }} <a href="https://flowbite.com/" class="hover:text-black">Wibukoding</a>. All Rights Reserved.
            </span>
            ...
            <div class="flex mt-4 justify-center">
                ...
                <a href="#" class="text-gray-500 hover:text-black ms-5">
